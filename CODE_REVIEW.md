...
- [方法论报告](#REPORTmd) — `REPORT.md`
- [项目工作日志](#PROGRESSmd) — `PROGRESS.md`
- [依赖清单](#requirementstxt) — `requirements.txt`
- [Git 忽略规则](#gitignore) — `.gitignore`
- [CI/CD 工作流](#githubworkflowsmedical_trackeryml) — `.github/workflows/medical_tracker.yml`
- [核心模块: 拐点检测与评估](#srcmodelsturning_pointspy) — `src/models/turning_points.py`
- [数据源: AKShare](#srcdata_fetcherakshare_sourcepy) — `src/data_fetcher/akshare_source.py`
- [数据源: FRED](#srcdata_fetcherfred_sourcepy) — `src/data_fetcher/fred_source.py`
- [数据源: Yahoo Finance (备用)](#srcdata_fetcheryfinance_sourcepy) — `src/data_fetcher/yfinance_source.py`
- [工具: 手动数据导入](#srcdata_fetchermanual_inputpy) — `src/data_fetcher/manual_input.py`
- [工具: OCR 截图提取](#srcdata_fetcherocr_capturepy) — `src/data_fetcher/ocr_capture.py`
- [数据源包初始化](#srcdata_fetcher__init__py) — `src/data_fetcher/__init__.py`
- [模型包初始化](#srcmodels__init__py) — `src/models/__init__.py`
- [应用: CLI 跟踪器](#apptrackerpy) — `app/tracker.py`
- [应用: HTML 看板生成器](#appdashboardpy) — `app/dashboard.py`
- [应用: 推送通知](#appnotifypy) — `app/notify.py`
- [应用: CI 输出解析](#appci_parsepy) — `app/ci_parse.py`
...
**文件**: `.github/workflows/medical_tracker.yml`
...
**文件**: `src/models/turning_points.py`
...
**文件**: `src/data_fetcher/akshare_source.py`
...
**文件**: `src/data_fetcher/fred_source.py`
...
**文件**: `src/data_fetcher/yfinance_source.py`
...
**文件**: `src/data_fetcher/manual_input.py`
...
**文件**: `src/data_fetcher/ocr_capture.py`
...
**文件**: `src/data_fetcher/__init__.py`
